...
Tables~\ref{tab:cdhscrs} and~\ref{tab:cdhsdrs} record the difference in the CDHS values as estimated by \pso\ and
Stochastic Gradient Ascent for a sample of planets under CRS and DRS respectively. Tables~\ref{tab:ceesacrs}
and~\ref{tab:ceesadrs} record the same for the CEESA scores.
